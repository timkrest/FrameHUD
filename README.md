...
<img src="docs/panel-scroll.gif" alt="The panel over the sample app while scrolling a list" width="420">

JankStats hands you a callback per frame. FrameHUD is what you would build on top of it: the panel,
statistics per screen and session, and a jank gate for tests. [How it compares](docs/comparison.md)
with Macrobenchmark, Perfetto and Play Vitals.
...
- [How to tell which stage of the frame is making your app janky](docs/article-frame-phases.md):
  two rendering bugs that a frame counter reports as the same, measured on a Galaxy S25 Ultra
