...
приложения, контекст, устройство, версия приложения, состояние измерений и проблемы достоверности.
...
забирает тот каталог, который выбрало устройство. Сборка без флага отладки игнорирует все команды.
...
отправить отчёт или отдать на замер окно диалога.
